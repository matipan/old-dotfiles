...
" Replace mode
	...
	"let g:airline#themes#kriox#palette.replace = copy(airline#themes#kriox#palette.insert)
	"let g:airline#themes#kriox#palette.replace.airline_a = [ s:I1[0] , s:RE[0] , s:I1[2] , s:RE[1] , '' ]
	"let g:airline#themes#kriox#palette.replace_modified = g:airline#themes#kriox#palette.insert_modified
